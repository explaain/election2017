...
app.get('/', function(req, res, next) {
  ...
  // res.render('index', { standalone: false, embed: false, embedSwitch: 'default',  brand: process.env.SITE_BRAND || 'ge2017', step: '', phrase: '', quiz: false });
});
app.get('/students/', function(req, res, next) {
  res.render('index', { standalone: true, embed: false, embedSwitch: 'default', brand: process.env.SITE_BRAND || 'ge2017', step: 'postcode-compare', phrase: '', quiz: false });
});
...
app.get('/student/', function(req, res, next) {
  ...
  //res.render('/index', { standalone: true, embed: false, embedSwitch: 'default', brand: process.env.SITE_BRAND || 'ge2017', step: req.params.step, phrase: '', quiz: false });
});

app.get('/embed/:step', function(req, res, next) {
  res.render('index', { standalone: false, embed: true, embedSwitch: 'default', brand: process.env.SITE_BRAND || 'ge2017', step: req.params.step, phrase: '', quiz: false });
});

app.get('/policy', function(req, res, next) {
  res.render('index', { standalone: true, embed: false, embedSwitch: 'default', brand: process.env.SITE_BRAND || 'ge2017', step: 'policy', phrase: '', quiz: false });
});
...
app.get('/shared/:party?/:percentage?', function(req, res, next) {
  ...
  res.render('index', { standalone: true, embed: false, embedSwitch: 'default', brand: process.env.SITE_BRAND || 'ge2017', step: 'quiz', phrase: '', quiz: true, params: req.params });
})
...
app.get('/phrase/iWantTo/', function(req, res, next) {
  res.render('index', { standalone: true, embed: false, embedSwitch: 'default', brand: process.env.SITE_BRAND || 'ge2017', step: '', phrase: 'iWantTo', quiz: true });
});
