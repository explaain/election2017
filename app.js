...
app.get('/', function(req, res, next) {
  res.render('index', { standalone: false, embed: false,  brand: process.env.SITE_BRAND || 'ge2017', step: '', quiz: false });
});
app.get('/students/', function(req, res, next) {
  res.render('index', { standalone: true, embed: false, brand: process.env.SITE_BRAND || 'ge2017', step: 'postcode-compare', quiz: false });
});
...
app.get('/student/', function(req, res, next) {
  ...
  //res.render('/index', { standalone: true, embed: false, brand: process.env.SITE_BRAND || 'ge2017', step: req.params.step, quiz: false });
});

app.get('/embed/:step', function(req, res, next) {
  res.render('index', { standalone: false, embed: true, brand: process.env.SITE_BRAND || 'ge2017', step: req.params.step, quiz: false });
});

app.get('/policy', function(req, res, next) {
  res.render('index', { standalone: true, embed: false, brand: process.env.SITE_BRAND || 'ge2017', step: 'policy', quiz: false });
});

app.get('/quiz', function(req, res, next) {
  res.render('index', { standalone: true, embed: false, brand: process.env.SITE_BRAND || 'ge2017', step: 'quiz', quiz: true });
});
